...
//  def this() = this(DefaultJDBCWrapper, awsCredentials => AmazonS3ClientBuilder.standard().withCredentials(awsCredentials)
//  .withEndpointConfiguration(new EndpointConfiguration("s3.cn-north-1.amazonaws.com.cn","cn-north-1")).build().
